...
public class ListarDanoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_dano);

        cargarPreferencias();
        progressDialog = new ProgressDialog(ListarDanoActivity.this);
        ...
        if(networkInfo != null && networkInfo.isConnected()) {
            Thread thread = new Thread() {
                @Override
                public void run() {
                    final String resultado = listarDanosGET(tienda);
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (validar == 0) {
                                ...
                                progressDialog.dismiss();
                                cargarLista(listarDanos((resultado)));
                                Toast.makeText(getApplicationContext(), "Se han cargado las ventas exitosamente.", Toast.LENGTH_SHORT).show();
                                adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, listarDanos(resultado)) {
    ...
    public ArrayList<String> listarDanos(String response){
    ...
    public String listarDanosGET(String tienda) {
        URL url = null;
        String linea = "";
        int respuesta = 0;
        StringBuilder resul = null;
        String url_local = "http://192.168.56.1/ServiciosWeb/listarVentasBD.php?";
        String url_aws = "http://52.67.38.127/hitech/listarVenta.php?";
