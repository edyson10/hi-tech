...
public class ListarVentaTelefonoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_venta_telefono);

        cargarPreferencias();
        progressDialog = new ProgressDialog(ListarVentaTelefonoActivity.this);
        listaVentas = (ListView) findViewById(R.id.listVentasTel);
        //cargarTitulo();
    ...
    public ArrayList<String> listarVentasDia(String response){
        ...
        try{
            ...
            for (int i = 0;i<jsonArray.length();i++){
                texto = "ID Venta: " + jsonArray.getJSONObject(i).getString("id_venTelefono") + "\n"
                        + "Imei: " + jsonArray.getJSONObject(i).getString("imei") + "\n"
    ...
    public String listarVentasGET(String tienda) {
        ...
        String url_aws = "http://52.67.38.127/hitech/listarVentaTelefono.php";
